...
Watching me work has to be the least cinematic experience ever: reclining suburbanite in cargo shorts and a tee shirt stops typing, stares menacingly out the window for some moments, smiles. His expression then relaxes as he types again. After four hours he eats lunch, then does more of the same. Maybe the director will ask the lighting designer to do something interesting for the montage to close the scene with a good sunset. I like that it is meditative.
...
However, it is not meditative. Sometimes I'll set aside Claude Code and  write some example Scala structures just the way I want, or write text directives with nothing else running to get back to that relaxed, focused state.

---

**Reading:** Cory Doctorow's [_Little Brother_](https://craphound.com/category/littlebrother/). Fun start. Great pace.

**Listening:** [The Mistholme Museum of Mystery, Morbidity, and Mortality](https://shows.acast.com/the-mistholme-museum-of-mystery-morbidity-and-mortality). Good vignettes for driving...and it seems there's a larger plot after all.
