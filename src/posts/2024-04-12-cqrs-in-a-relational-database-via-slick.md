---
layout: post
title: CQRS in a Relational Database via Slick
description: "CQRS suits systems where inbound data is a stream of events but something needs a coherent view of state. How we built one on Slick and a relational database."
comments: True
tags:
  - post
  - Scala
...
![Events flow into an event queue and event storage under Command Responsibility; state storage answers queries under Query Responsibility]({{ '/img/posts/2024-04-12-cqrs-diagram.png' | url }})
...
*[Famous Blue Muppet is taken aback.](https://archive.org/details/stnmnst/JPEG/stnmnst0007.jpg)*<sup>[1](#a-note-on-famous-blue-muppet)</sup>
...
You might recall ["The Barn Pole Paradox"](https://www.phys.unsw.edu.au/einsteinlight/jw/module4_pole_paradox.htm) from relativity physics. Computing is worse.
...
Jon Stone wrote this amazing book about dread, anticipation, and the gap between the two. It makes a great introduction to a discussion of The Sunk Cost Fallacy. It is essential reading alongside critiques of software development lifecycle trends.

You should own a physical copy. The book can express your concerns very quickly, but it does not work on a screen. You don't want some Famous Blue Muppet sabotaging your trackpad.
